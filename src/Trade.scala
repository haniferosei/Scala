...
class Trade private(val id: String, val symbol: String, var quantity: Int, var _price: Double){
...
object  Trade{
  def apply(  id: String,  symbol: String,   quantity: Int,  _price: Double): Trade ={
    val t = new Trade(id,symbol,quantity,_price)                //use it to construct an instance
